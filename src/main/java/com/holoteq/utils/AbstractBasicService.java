...
//	}
	...
	public long createDefault(DTO dto) {
		...
		return (long) getRepository().save(convertToEntity(dto)).getId();
	}
	...
	public void updateDefault(Long id, DTO dto) {
		...
		ENTITY entity = getEntityById((Long) dto.getId());
